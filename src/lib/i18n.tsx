...
const translations = {
  sv: {
    ...
    work: {
      ...
      imageAlts: [
        "Långt brunt hår med mjuka karamellfärgade slingor och vågor",
        "Kopparfärgat lockigt hår stylat med mycket volym",
        "Blond page med ljusa slingor och mjukt böjda toppar",
        "Närbild av mörkt vågigt hår med kopparfärgade slingor",
        "Långt blont hår med dimensionella slingor och mjuka vågor",
        "Långt brunt hår med glansig toning och stora vågor",
        "Långt askblont hår med ljusa slingor och lockar",
      ],
  ...
  en: {
    ...
    work: {
      ...
      imageAlts: [
        "Long brown hair with soft caramel highlights and waves",
        "Copper-coloured curly hair styled with high volume",
        "Blonde bob with bright highlights and softly curved ends",
        "Close-up of dark wavy hair with copper highlights",
        "Long blonde hair with dimensional highlights and soft waves",
        "Long brown hair with a glossy toner and large waves",
        "Long ash-blonde hair with bright highlights and curls",
      ],
